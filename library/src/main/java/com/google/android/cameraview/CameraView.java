...
public class CameraView extends FrameLayout {
    ...
    private TouchFocusFeedbackView mTouchFocusFeedbackView;
    ...
    public CameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTouchFocusFeedbackView = new TouchFocusFeedbackView(getContext());
        addView(mTouchFocusFeedbackView);
        ...
        mGestureDetectorCompat = new GestureDetectorCompat(context, new SimpleOnGestureListener() {
            ...
            public boolean onSingleTapUp(MotionEvent e) {
                ...
                Log.d(TAG, String.format("Tapped on (%d, %d)", x, y));
                if (mImpl instanceof TapFocusable) {
                    ((TapFocusable) mImpl).setFocusTarget(x, y);
                    mTouchFocusFeedbackView.animateTouchTarget(x, y);
                    return true;
                }
                return false;
            }
